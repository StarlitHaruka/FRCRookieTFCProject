...
public final class Ports {
  ...
  public static final class Shooter {
    public static final int TOP_MOTOR = 6; // good
    public static final int BOTTOM_MOTOR = 9; // good
  }
  ...
  public static final class Feeder {
    public static final int FEEDER_SPARK = 10; // good
    public static final int BEAMBREAK = 0;
  }

  public static final class Drive {
    public static final int FRONT_LEFT_DRIVE = 2; // good
    public static final int REAR_LEFT_DRIVE = 4; // good
    public static final int FRONT_RIGHT_DRIVE = 3;
    public static final int REAR_RIGHT_DRIVE = 1; // good
  ...
  public static final class Intake {
    ...
    public static final int INTAKE_SPARK = 5; // good
  }
